				...
				<div className="uploadContent">
					...
					<div className="uploadButtons">
						...
						<>
							...
							<div className="trashBtn" onClick={handleTrash}><FaTrashAlt color="#8e49dc" style={{width: 30, height: 30}}/></div>
						</>
						}
					</div>
					...
					<div className="closeBtn" onClick={closeUpload}><IoCloseCircle color="#8e49dc" style={{width: 30, height: 30}} /></div>
				</div>
			</div>
		</div>
	);
